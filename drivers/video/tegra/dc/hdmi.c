...
const struct tegra_hdmi_audio_config tegra_hdmi_audio_32k[] = {
	...
	{108000000,	4096,	123750,	24000},	//by David add 
...
const struct tegra_hdmi_audio_config tegra_hdmi_audio_44_1k[] = {
	...
	{108000000,	4704,	123750,	20000}, //by David add
...
const struct tegra_hdmi_audio_config tegra_hdmi_audio_48k[] = {
	...
	{108000000,	6144,	123750,	24000}, //by David add	
...
const struct tegra_hdmi_audio_config tegra_hdmi_audio_88_2k[] = {
	...
	{108000000,	9408,	123750,	20000}, //by David add	
...
const struct tegra_hdmi_audio_config tegra_hdmi_audio_96k[] = {
	...
	{108000000,	12288,	123750,	24000}, //by David add	
...
const struct tegra_hdmi_audio_config tegra_hdmi_audio_176_4k[] = {
	...
	{108000000,	18816,	123750,	20000}, //by David add	
...
const struct tegra_hdmi_audio_config tegra_hdmi_audio_192k[] = {
	...
	{108000000,	24576,	123750,	24000}, //by David add	
...
static bool tegra_dc_hdmi_detect(struct tegra_dc *dc)
{
	...
	dev_dbg(&dc->ndev->dev, "tegra_dc_hdmi_detect>>>>>>>\n");
...
char g_disable_irq=0;
char g_connect_status=2;
static irqreturn_t tegra_dc_hdmi_irq(int irq, void *ptr)
{
	...
	dev_err(&dc->ndev->dev, "tegra_dc_hdmi_irq>>>>>>>>>>>1 enable[%d]\n",hdmi->dc->enabled);
        if(g_disable_irq == 1)		
	{
	      goto skip_irq;
	}
	//if(hdmi->dc->connected == g_connect_status)
	//{
	//     goto skip_irq;	 
	//}
	dev_err(&dc->ndev->dev, "tegra_dc_hdmi_irq>>>>>>>>>>>2 connected[%d] \n",hdmi->dc->connected);	
	...
	//g_connect_status=hdmi->dc->connected;
skip_irq:
	return IRQ_HANDLED;
}
...
static void wolo_tegra_dc_hdmi_enable(struct tegra_dc *dc)
{	
	tegra_dc_hdmi_enable(dc);
	//set_S50_status(1);
}
...
static void wolo_tegra_dc_hdmi_disable(struct tegra_dc *dc)
{
        //move to suspend
        tegra_dc_hdmi_disable(dc);
}
...
struct tegra_dc_out_ops tegra_dc_hdmi_ops = {
	...
	.enable = wolo_tegra_dc_hdmi_enable,
	//.disable = tegra_dc_hdmi_disable,
	.disable = wolo_tegra_dc_hdmi_disable,
