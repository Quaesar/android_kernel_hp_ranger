...
static struct i2c_board_info __initdata rt5636_board_info = {
	I2C_BOARD_INFO("rt5636", 0x1c),
};
...
static void macallan_i2c_init(void)
{
	...
	i2c_register_board_info(0, &rt5636_board_info, 1);
}
...
static void macallan_audio_init(void)
{
	...
	macallan_audio_pdata.codec_name = "rt5636.0-001c";
	macallan_audio_pdata.codec_dai_name = "rt5636-aif1";
}
