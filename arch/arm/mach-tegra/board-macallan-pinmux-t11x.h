...
// Wolo: end-- Wifi_BT
	...
	DEFAULT_PINMUX(GPIO_PU0,	UARTA,		 NORMAL,	NORMAL, 	OUTPUT),	// TXD
	DEFAULT_PINMUX(GPIO_PU1,	UARTA,		 NORMAL,	TRISTATE,	  INPUT),	// RXD	
	...
	GPIO_PINMUX(GPIO_X5_AUD, NORMAL, NORMAL, OUTPUT, DISABLE),// GPS Power Enable
	GPIO_PINMUX(GPIO_X6_AUD, PULL_UP, NORMAL, INPUT, DISABLE),
  GPIO_PINMUX(GPIO_X7_AUD, NORMAL, NORMAL, OUTPUT, DISABLE),//WLAN_PWR_EN
	GPIO_PINMUX(GPIO_W2_AUD, PULL_UP, NORMAL, INPUT, DISABLE),
	//GPIO_PINMUX(GPIO_W3_AUD, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GPIO_W3_AUD, PULL_UP, NORMAL, OUTPUT, DISABLE),//LAN9514_RSTn
...
// Wolo: start-- Wifi_BT
	...
	GPIO_PINMUX(CLK2_REQ, PULL_DOWN, NORMAL, OUTPUT, DISABLE),  //WF_EN
// Wolo: end-- Wifi_BT
...
// Wolo: start-- Wifi_BT
	...
	GPIO_PINMUX(KB_ROW1, NORMAL, NORMAL, OUTPUT, DISABLE), //BT_EN
// Wolo: end-- Wifi_BT
	...
	GPIO_PINMUX(KB_ROW5, NORMAL, NORMAL, OUTPUT, DISABLE),
	 //LAN_PWR_EN
	GPIO_PINMUX(KB_ROW6, NORMAL, NORMAL, OUTPUT, DISABLE),//LAN_PWR_EN
	...
	GPIO_PINMUX(USB_VBUS_EN0, PULL_UP, NORMAL, OUTPUT, DISABLE),
};
...
//	UNUSED_PINMUX(USB_VBUS_EN0),
	UNUSED_PINMUX(USB_VBUS_EN1),//RANGER_TEST_HUB1
};
...
// Wolo: start-- Wifi_BT
	//GPIO_INIT_PIN_MODE(TEGRA_GPIO_PX7, false, 0),  //WLAN_PWR_EN
// Wolo: end-- Wifi_BT
...
// Wolo: start-- Wifi_BT
	//GPIO_INIT_PIN_MODE(TEGRA_GPIO_PCC5, false, 0),  //WLAN_EN
// Wolo: end-- Wifi_BT
